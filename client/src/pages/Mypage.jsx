...
function Mypage() {
  ...
  function userInfoAxios() {
    return axios
      .get(`${process.env.REACT_APP}/users/my-page`, noBodyOptions)
      .then((res) => {
  ...
  function patchUserData(id) {
    ...
    return axios
      .patch(`${process.env.REACT_APP}/users/${id}`, patchdata, withBodyOptions)
      .then((res) => {
  ...
  const deleteUser = (id) => {
    // e.preventDefault();
    return axios
      .delete(`${process.env.REACT_APP}/users/${state.user.userId}`, noBodyOptions)
      .then((res) => {
        console.log(`res.data:`);
        console.log(res.data);
