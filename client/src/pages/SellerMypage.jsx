...
function Mypage() {
  ...
  function sellerInfoAxios() {
    return axios
      .get(`${process.env.REACT_APP}/sellers/my-page`, noBodyOptions)
      .then((res) => {
  ...
  function patchSellerData(id) {
    ...
    return axios
      .patch(`${process.env.REACT_APP}/sellers/${id}`, patchdata, withBodyOptions)
      .then((res) => {
        console.log(`res.data:`);
        console.log(res.data);
  ...
  const deleteSeller = () => {
    return axios
      .delete(`${process.env.REACT_APP}/users/${state.user.sellerId}`, noBodyOptions)
      .then((res) => {
        console.log(`res.data:`);
        console.log(res.data);
