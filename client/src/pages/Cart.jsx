...
const Cart = () => {
  ...
  const cartGetItem = async () => {
    return await axios
      .get(`${process.env.REACT_APP}/carts?page=1&size=10`, options)
      .then((res) => {
  ...
  const handleIncrease = async (id) => {
    ...
    return await axios
      .patch(
        `${process.env.REACT_APP}/carts/products/${id}/plus`,
        null,
        options
      )
      .then((res) => {
  ...
  const handleDecrease = async (id) => {
    ...
    return await axios
      .patch(
        `${process.env.REACT_APP}/carts/products/${id}/minus`,
        null,
        options
      )
      .then((res) => {
  ...
  const handleDelete = async (id) => {
    return await axios
      .delete(`${process.env.REACT_APP}/carts/products/${id}`, options)
      .then((res) => {
        console.log(res);
        window.location.reload();
      })
